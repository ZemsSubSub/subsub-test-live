    ...
    host.innerHTML =
      ...
      '<div class="lv-dhead"><div class="lv-dhead__l">' +
        ...
        '<div class="lv-dmeta"><span>' + st.count + (st.count === 1 ? " video" : " videos") + " · " + UI.dur(st.sec) + " · " + UI.bytes(st.bytes) +
          (st.off ? " · " + st.off + " off" : "") + "</span></div>" +
        '<div class="lv-dmeta"><span>' + (draft ? "Not saved yet" : used.length ? "Used in " + UI.plural(used.length, "stream", "streams") + ":" : "Not used in streams") + "</span>" +
          (!draft && used.length
